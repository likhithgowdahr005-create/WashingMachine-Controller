...
# 3 "washing_machine.c" 2
# 1 "./matrix_keypad.h" 1
# 28 "./matrix_keypad.h"
unsigned char read_matrix_keypad(unsigned char mode);
void init_matrix_keypad(void);
# 4 "washing_machine.c" 2
# 1 "./washing_machine.h" 1
# 19 "./washing_machine.h"
...
void washing_machine_task(unsigned char key)
{
    ...
    clcd_print("Press key 5 to", (0xC0 + 0));
    clcd_print("Power ON Wash", (0x90 + 0));
    ...
    break;
        ...
        case 0x20:
            ...
            clcd_putch('*', (0xC0 + 0));
            clcd_print(programs[program_index], (0xC0 + 1));
            clcd_print("SW4:Scroll", (0xD0 + 0));
        ...
        case 0x30:
            ...
            clcd_putch('*', (0xC0 + 0));
            clcd_print(water_levels[water_index], (0xC0 + 1));
            clcd_print("SW4:Scroll", (0xD0 + 0));
...
else
{
    if (door_shown == 1)
    {
        ...
        door_shown = 0;
            ...
            clcd_print("Function - wash", (0x80 + 0));
        ...
        case 0x60:
{
    ...
    if (done_once == 0)
    {
        ...
        clcd_print("Press 5 for Menu", (0x90 + 0));
        done_once = 1;
    }
