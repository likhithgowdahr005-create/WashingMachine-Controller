...
static unsigned char scan_keypad(void)
{
    ...
    if (RB0 == 0) return 1;
    else if (RB1 == 0) return 2;
    else if (RB2 == 0) return 3;


    RD3 = 1; RD2 = 0; RD1 = 1; RD0 = 1;
    for (i = 100; i--; );

    if (RB0 == 0) return 4;
    else if (RB1 == 0) return 5;
    else if (RB2 == 0) return 6;


    RD3 = 1; RD2 = 1; RD1 = 0; RD0 = 1;
    for (i = 100; i--; );

    if (RB0 == 0) return 7;
    else if (RB1 == 0) return 8;
    else if (RB2 == 0) return 9;
    ...
    if (RB0 == 0) return '*';
    else if (RB1 == 0) return 0;
    else if (RB2 == 0) return '#';
